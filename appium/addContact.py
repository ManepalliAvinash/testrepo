...
#save_list[6].click()
#time.sleep(5)
driver.find_element(by=AppiumBy.ID,value="com.samsung.android.app.contacts:id/nameEdit").send_keys("Groot")
...
time.sleep(5)
driver.find_element(by=AppiumBy.XPATH,value="//android.widget.EditText[@text='Phone']").send_keys("7013388705")
